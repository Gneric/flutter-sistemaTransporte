        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                children: <Widget>[
                  Row(
                      ...
                      children: <Widget>[
                        Text(_soles[tipo], style: TextStyle(color: _colors[tipo], fontWeight: FontWeight.bold, fontSize: 25)),
                        Icon(
                          _icons[tipo],
                          color: _colors[tipo],
                          size: 40,
                        ...
                        SizedBox(width: 10),
                        Text(mensaje, style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold ),),
                      ],
                    ),  
                ],
              ),
              ...
              Divider(),               
              ListTile(
                    title: Text('Date', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold ) ,),
                    subtitle: Text(date),                   
              ),
              Divider(),
              ListTile(
                    title: Text('Hora', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold )),
                    subtitle: Text(hora),
                ),
            ],
          ),
