...
class CorredorStationProvider extends ChangeNotifier {
  ...
  Future<List<Station>> getListaEstacionesCorredor() async {
    HttpClient httpClient = new HttpClient();
    String url = "https://webapi-sit.azurewebsites.net/estacionesGet/estaciones/3";
